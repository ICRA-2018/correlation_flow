...
RUN mkdir ${HOME}/correlation-flow

COPY . ${HOME}/correlation-flow

#################################### CATKIN ####################################

RUN mkdir -p ${HOME}/catkin_ws/src && ln -s ${HOME}/correlation-flow ${HOME}/catkin_ws/src/.
